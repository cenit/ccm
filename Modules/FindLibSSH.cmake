...
#
#  Edited (2019) by Alessandro Fabbri <rommacc@yahoo.it>
#
...
if (LIBSSH_LIBRARIES AND LIBSSH_INCLUDE_DIRS)
  ...
  if (SSH_FOUND)
    ...
    if (LIBSSH_VERSION_MAJOR)
      ...
      file(STRINGS ${LIBSSH_INCLUDE_DIR}/libssh/libssh.h LIBSSH_VERSION_MINOR REGEX "#define[ ]+LIBSSH_VERSION_MINOR[ ]+[0-9]+")
      string(REGEX MATCH "[0-9]+" LIBSSH_VERSION_MINOR ${LIBSSH_VERSION_MINOR})
      file(STRINGS ${LIBSSH_INCLUDE_DIR}/libssh/libssh.h LIBSSH_VERSION_PATCH REGEX "#define[ ]+LIBSSH_VERSION_MICRO[ ]+[0-9]+")
  ...
  message(STATUS "Found LibSSH v${LibSSH_VERSION}")
