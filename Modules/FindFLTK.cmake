...
if(WIN32)
  if(NOT CYGWIN)
    if(BORLAND)
      ...
      set( FLTK_PLATFORM_DEPENDENT_LIBS wsock32 comctl32 ${JPEG_LIBRARY})
    endif()
  endif()
endif()
...
if(UNIX)
  ...
  if(${os_version_suffix})
    if(${os_version_suffix} STREQUAL ".el6")
      find_library(FLTK_Xrender_LIBRARY Xrender)
      find_library(FLTK_Xft_LIBRARY Xft)
    endif()
  endif()
  set(FLTK_PLATFORM_DEPENDENT_LIBS ${X11_LIBRARIES} ${FLTK_MATH_LIBRARY} ${FLTK_Xrender_LIBRARY} ${FLTK_Xft_LIBRARY} )
  message(STATUS "List of FLTK dependencies: ${FLTK_PLATFORM_DEPENDENT_LIBS}")
endif()
